# Selected A verification

The pre-refinement R9 round covered all three concepts at320×740,390×844,412×732,900×900 and1440×900 in both schemes. JSON records retain source hashes. The selected A tablet rail correction affects only701–1100px; affected900px frames were refreshed while unaffected captures retained their hashes. Primary phone/desktop drives proved real input scrolling; additional static frames reuse that input evidence and assert their own geometry.
...
`full-phone/` supersedes the detached Live Activity card geometry in
`refinement/`. Locked source:
`58193d5cc9c861a3d1d7906fd87f2a61c6b770e0b3b28cbdf3b3070830b5504a`.
Bounded captures cover 390×844 dark, 1440×900 light and 320×740 dark, at 2×.
The new full system screenshot and F1 screenshot keep their 1206×2622 ratio.
All images decode; no horizontal overflow. Real touch/wheel drives reach the
footer. Desktop and phone pixels were inspected by root and the Astra designer.
Unchanged header/docs/CTA/rail behavior retains its earlier verification;
this refinement did not restart or replace the full matrix.
