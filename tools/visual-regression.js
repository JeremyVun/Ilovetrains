...
const SCREENS = [
  ...
  ['home-lost-riding', 'home-lost-riding', 'home-lost-riding', null],
  ['home-lost-dwell', 'home-lost-dwell', 'home-lost-dwell', null],
  ['home-lost-none', 'home-lost-none', 'home-lost-none', null],
  ...
  ['home-lost-riding', null, null, 'home-lost-riding'],
  ['home-lost-dwell', null, null, 'home-lost-dwell'],
  ['home-lost-none', null, null, 'home-lost-none'],
  ...
  ['setup-location-idle', null, 'setup-location-idle', 'setup-location-idle'],
  ['setup-location-idle-light', null, 'setup-location-idle-light', 'setup-location-idle-light'],
  ['setup-location-denied', null, 'setup-location-denied', 'setup-location-denied'],
  ['setup-location-denied-light', null, 'setup-location-denied-light', 'setup-location-denied-light'],
  ['setup-location-failed', null, 'setup-location-failed', 'setup-location-failed'],
  ['setup-location-failed-light', null, 'setup-location-failed-light', 'setup-location-failed-light'],
  ['setup-location-approximate', null, 'setup-location-approximate', 'setup-location-approximate'],
  ['setup-location-approximate-light', null, 'setup-location-approximate-light', 'setup-location-approximate-light'],
