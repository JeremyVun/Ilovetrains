...
[app, tests, ui_tests].each do |target|
  target.build_configurations.each do |config|
    config.build_settings.merge!({
      ...
      'DEVELOPMENT_TEAM' => '6TTZ5U96V9', 'MARKETING_VERSION' => version,
      'CURRENT_PROJECT_VERSION' => '4', 'ENABLE_USER_SCRIPT_SANDBOXING' => 'YES',
...
[[app, 'ILoveTrains'], [tests, 'ILoveTrainsTests'], [ui_tests, 'ILoveTrainsUITests']].each do |target, dir|
...
%w[calibration.json prediction.json rows.json].each do |name|
